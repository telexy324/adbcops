...
const (
	...
	EventSourceLinuxServer   = "linux_server"

	EventTypeLinuxHostUnreachable    = "linux_host_unreachable"
	EventTypeLinuxSSHAuthFailed      = "linux_ssh_auth_failed"
	EventTypeLinuxSSHHostKeyChanged  = "linux_ssh_host_key_changed"
	EventTypeLinuxCPUPressure        = "linux_cpu_pressure"
	EventTypeLinuxMemoryPressure     = "linux_memory_pressure"
	EventTypeLinuxSwapPressure       = "linux_swap_pressure"
	EventTypeLinuxFilesystemPressure = "linux_filesystem_pressure"
	EventTypeLinuxInodePressure      = "linux_inode_pressure"
	EventTypeLinuxDiskIOPressure     = "linux_disk_io_pressure"
	EventTypeLinuxNetworkError       = "linux_network_error"
	EventTypeLinuxProcessZombie      = "linux_process_zombie"
	EventTypeLinuxProcessDState      = "linux_process_d_state"
	EventTypeLinuxServiceFailed      = "linux_service_failed"
	EventTypeLinuxTimeUnsynchronized = "linux_time_unsynchronized"
	EventTypeLinuxKernelOOM          = "linux_kernel_oom"
	EventTypeLinuxKernelIOError      = "linux_kernel_io_error"
	EventTypeLinuxFilesystemReadOnly = "linux_filesystem_read_only"
